...
function initMap() {
    ...
    var barsMarkers = [
        {
            ...
            content: "<h6>The Bootlegger</h6><p>Opened in Bristol in April 2014 - The Bristol Bootlegger - Prohibition inspired Performance and Cocktails - The accessible speakeasy</p>"
        },
        {
            location: { lat: 51.45208019765397, lng: -2.5923166461624367 },
            content: "<h6>The Apple</h6><p>Bustling cider pub on 2 floors of a moored boat with bench seats on the cobblestone quayside.</p>"
        },
        {
            location: { lat: 51.45713373493726, lng: -2.6078536473964733 },
            content: "<h6>London Cocktail Club Bristol</h6><p>Leave your inhibitions at the door & let your fantasies run wild; it’s LCC’s twisted ode to Neverland at night.</p>"
        },
        {
            location: { lat: 51.451586137870684, lng: -2.607606084177607 },
            content: "<h6>Bag of Nails, Bristol</h6><p>The bestest pub in the world. Or at least that street. Official. There are cats!</p>"
        },
        {
            location: { lat: 51.456568190306896, lng: -2.6067294631679627 },
            content: "<h6>Be At One Bristol</h6><p>Lively chain bar that serves sweet, sour and spicy cocktails, and offers mixing masterclasses.</p>"
        },
        {
            location: { lat: 51.453875443172066, lng: -2.5947276641388126 },
            content: "<h6>Brozen Bar</h6><p>A speciality cocktail bar situated in the heart of the city. Come and try our delicious frozen cocktails and alcoholic ice creams made in front of your eyes</p>"
        },
        {
            location: { lat: 51.4546788839588, lng: -2.6208507362603837 },
            content: "<h6>The Bristol Fringe</h6><p>Entertainment 7 days a week From comedy to Jazz and free live music gigs The Bristol Fringe is a leading live music venue in Clifton Village.</p>"
        },
        {
            location: { lat: 51.4615883490576, lng: -2.6024596358927505 },
            content: "<h6>Highbury Vaults</h6><p>Real ales and comfort food in snug, 19th-century pub with dark-wood panelling, plus patio garden.</p>"
        },
        {
            location: { lat: 51.45245290596501, lng: -2.589354949872197 },
            content: "<h6>The Fleece</h6><p>Independent live music venue situated in the heart of Bristol offering gigs and club nights 7 nights per week since 1982!</p>"
        },
        {
            location: { lat: 51.4491199329655, lng: -2.594165370302849 },
            content: "<h6>Thekla</h6><p>Thekla is a world-famous, award-winning live music venue and club space on board a converted German cargo ship, moored in Bristol's Floating Harbour since 1984.</p>"
        }
    ];
    ...
    var placesMarkers = [
        {
            ...
            content: "<h6>The Bristol</h6><p>Welcome to The Bristol! Anyone spending any length of time in Bristol is likely to come across our iconic building. Enviably situated on the quayside of the Floating Harbour, this luxury Bristol hotel is surrounded by the best of Bristol's Old City</p>"
        },
        {
        ...
        },
        {
            ...
            content: "<h6>Hotel du Vin Bristol</h6><p>See why so many travelers make Hotel du Vin & Bistro their hotel of choice when visiting Bristol. Providing an ideal mix of value, comfort and convenience, it offers a romantic setting with an array of amenities designed for travelers like you.</p>"
        },
        {
        ...
        },
        {
            ...
            content: "<h6>Hampton by Hilton Bristol Airport</h6><p>Hampton by Hilton Bristol Airport is ideally situated within walking distance of the main terminal. Our welcoming hotel provides the perfect start or end to any adventure or business trip.</p>"
        },
        {
    ...
    var familyMarkers = [
        ...
        },
        {
            ...
            content: "<h6>Clifton Suspension Bridge</h6><p>Designed and built in 1836 by a young engineer, Isambard Kingdom Brunel, this 702-foot-long, 250-foot-high suspension bridge gracefully spans the Avon Gorge between Clifton and Leigh Woods.</p>"
        },
        {
            location: { lat: 51.454153285216385, lng: -2.6067886362179586 },
            content: "<h6>Cabot Tower</h6><p>32-metre viewing tower, built in 1897, for 400th anniversary of John Cabot's voyage to Newfoundland.</p>"
        },
        {
        ...
        },
        {
            ...
            content: "<h6>Bristol Museum & Art Gallery</h6><p>Explore our free collections of art, nature and history on display in this beautiful building. Find out about the last billion years of earth's history, explore the region's natural wonders and discover more about peoples' lives, past and present.</p>"
        },
        {
            location: { lat: 51.46738463942296, lng: -2.7163303329706956 },
            content: "<h6>Oakham Treasures</h6><p>Homespun museum of retail & farming history, with vintage tractors & sweet shop & grocery displays.</p>"
        },
        {
        ...
        },
        {
            ...
            content: "<h6>Clifton Observatory and Caves</h6><p>The Clifton Observatory and Caves sits above the Avon Gorge offering superb views of the Clifton Suspension Bridge and the city of Bristol. The Observatory houses one of the only camera obscuras still open to the public in the UK.</p>"
        }
    ];
}